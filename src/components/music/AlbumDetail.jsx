  ...
  return (
    <div className="px-4 sm:px-6">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-end gap-6 mb-8">
        ...
        {/* ✅ FIXED: src mein JSX nahi, conditionally render karo */}
        {album.coverImage ? (
          <img
            src={album.coverImage}
            alt={album.title}
            className="w-32 h-32 sm:w-48 sm:h-48 object-cover rounded-lg shadow-2xl flex-shrink-0"
            onError={(e) => { e.target.src = ALBUM_PLACEHOLDER; }}
          />
        ) : (
          <div
